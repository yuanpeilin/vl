        ...
        <div class="blogbox">
            <div class="bloglist">
                <ul>
                    ...
                    <%--                        <p class="blogtext">--%>
                    <%--                            博客从最初的域名购买，到上线已经有四年的时间了，这四年的时间，有笑过，有怨过，有悔过，有执着过，也有放弃过…但最后还是坚持了下来，时间如此匆匆，等再回过头已来不及去弥补…</p>--%>
                    <%--                        <p class="bloginfo"><span>杨青</span><span>2018年3月19日</span><span><a href="/">个人博客模板</a></span>--%>
                    <%--                        </p>--%>
                    <%--                    </li>--%>
                    ...
                    %>
                    <li>
                        <h2><a href="/"><%=article.getTitle()%>
                        </a></h2>
                        <i><a href="/"><img src=<%="images/"+article.getPic()%>></a></i>
                        <p class="blogtext"><%=article.getText()%></p>
                        <p class="bloginfo">
                            <span>杨青</span>
